...
long_term_efficiency = input("long term efficiency:")
kg = float(input("kg: "))
...
print(f"One usage practical energy: efficiency:{one_usage_efficiency:.3f}% Joule: {long_term_practical_energy:.0f}")
